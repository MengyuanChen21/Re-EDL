...
def main(config_dict):
    ...
    for setting in itertools.product(seeds, lr_list, fisher_c_list, name_model_list, lamb1_list, lamb2_list, kl_c_list):
        (seed, lr, fisher_c, name_model, lamb1, lamb2, kl_c) = setting
        ...
        if name_model is not None:
            ...
            config_dict = OrderedDict(model_type=model_type, seed=seed, dataset_name=dataset_name, split=split,
                                      ...
                                      kl_c=kl_c, lamb1=lamb1, lamb2=lamb2)
        ...
        with torch.no_grad():
            ...
            id_Y_all, id_X_all, id_alpha_pred_all = \
                compute_X_Y_alpha(model, test_loader, device, return_softmax=return_softmax,
                                  mc_dropout=mc_dropout, mc_iter=mc_iter)
